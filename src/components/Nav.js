    ...
    <div className={navStyle.nav}>
      ...
      <div className={navStyle.navList}>
        <ul>
          ...
          <li>
            <Link to="/booking-a-table-on-the-little-lemon-website-react/about">
              About
            </Link>
          </li>
          <li>
            <Link to="/booking-a-table-on-the-little-lemon-website-react/menu">
              Menu
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/booking-a-table-on-the-little-lemon-website-react/login">
              Login
            </Link>
          </li>
        </ul>
