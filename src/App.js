...
function App() {
  ...
  const submitForm = (formData) => {
    if (submitData(formData)) {
      navigate(
        "/booking-a-table-on-the-little-lemon-website-react/confirm-reservations"
      );
    }
  };
  ...
  return (
    <div>
      <Routes>
        <Route
          path="/booking-a-table-on-the-little-lemon-website-react"
          element={<HomePage />}
        />
        <Route
        ...
        />
        <Route
          path="/booking-a-table-on-the-little-lemon-website-react/confirm-reservations"
          element={<ConfirmReservations />}
        />
      </Routes>
    </div>
  );
